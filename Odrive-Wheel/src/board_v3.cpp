...
// Phase 2a: ST USB Device Library removed — hUsbDeviceFS no longer exists.
// Provide a dummy USBD_HandleTypeDef so interface_usb.cpp's &usb_dev_handle
// address-taking code compiles. Shim functions in usb_tinyusb_glue.cpp ignore
// the pdev pointer.
...
// Phase 2a: OTG_FS_IRQHandler moved to src/usb_tinyusb_glue.cpp (calls
// tud_int_handler(0) directly). hpcd_USB_OTG_FS no longer exists.
